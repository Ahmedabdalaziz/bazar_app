...
class AuthorDetailsBody extends StatelessWidget {
  ...
  const AuthorDetailsBody({super.key, required this.authorId});
          ...
          return SingleChildScrollView(
            child: Column(
              children: [
                ...
                if (state.authorBooks != null && state.authorBooks!.isNotEmpty)
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<AuthorDetailsCubit>().retry(authorId);
                  },
