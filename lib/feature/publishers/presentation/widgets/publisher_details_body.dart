...
class PublisherDetailsBody extends StatelessWidget {
  final String publisherId;

  const PublisherDetailsBody({super.key, required this.publisherId});
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<PublishersCubit>().retry(publisherId);
                  },
